...
export default function EcommerceSubscriptionOverlayModal({
  open,
  onClose,
  onGoToFeatures,
}) {
      ...
      <div className="relative z-[101] flex min-h-screen items-center justify-center p-4 sm:p-6">
        <div className="w-full max-w-2xl rounded-2xl border border-brand-200 bg-white p-6 shadow-2xl sm:p-8">
          ...
          <h2 className="text-2xl font-bold text-gray-900 sm:text-3xl">
            E-Commerce Subscription Required
          </h2>

          <p className="mt-3 text-sm text-gray-700 sm:text-base">
            An active E-Commerce subscription is required to use online product
            sales, product checkout, and order management features.
          </p>
