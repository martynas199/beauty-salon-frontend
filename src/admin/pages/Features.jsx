      ...
      <div className="max-w-4xl mx-auto py-8 px-4">
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6">
          ...
          <button
            ...
            className="bg-brand-500 text-gray-900 py-2 px-4 rounded-lg font-semibold hover:bg-brand-600 transition-all"
          >
    ...
    <div className="max-w-4xl mx-auto py-8 px-4">
      ...
      >
        ...
        <div className="bg-white rounded-lg shadow-lg overflow-hidden border-2 border-brand-200">
          <div className="bg-brand-500 p-6 text-gray-900">
            <div className="flex items-center gap-3 mb-2">
              <CrownIcon className="w-8 h-8" />
              <h2 className="text-2xl font-bold">No Fee Bookings</h2>
            </div>
          ...
          <div className="p-6">
            {/* Current Status */}
            {isActive && (
              <div className="mb-6 p-4 bg-brand-50 border border-brand-300 rounded-lg">
                <div className="flex items-center gap-2 text-brand-900 font-semibold mb-2">
            ...
            <div className="mb-6">
              ...
              <ul className="space-y-2">
                <li className="flex items-start gap-2">
                  <CheckIcon className="text-brand-600 mt-1 w-4 h-4" />
